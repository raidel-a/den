...
var (
	Themes = map[string]Theme{
		"default": {
			...
			DimmedText:   lipgloss.Color("240"), // Darker gray
		...
		"dracula": {
			...
			DimmedText:   lipgloss.Color("242"), // Darker gray
			SelectedText: lipgloss.Color("255"), // White
		...
		"nord": {
			...
			DimmedText:   lipgloss.Color("245"), // Dimmed gray
			SelectedText: lipgloss.Color("255"), // White
		...
		"gruvbox": {
			...
			DimmedText:   lipgloss.Color("243"), // Dimmed gray
		...
		"solarized": {
			...
			DimmedText:   lipgloss.Color("241"), // Dimmed gray
